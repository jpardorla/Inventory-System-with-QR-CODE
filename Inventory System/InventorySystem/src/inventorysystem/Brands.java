...
public class Brands extends javax.swing.JFrame {
    ...
    public void addbrand() {
                String BrandName; //creates "respose" string
    BrandName = JOptionPane.showInputDialog //assignment of response 
      ("Enter New Brand");
    if (BrandName == null) 
      view();
    else
      ...
      view();
        ...
        try {
            if (!cnn.conn.isClosed()) {
                ...
                int BrandId = 0;
                String sql = "INSERT INTO brands VALUES('" + BrandId + "','" + BrandName + "');";
                stmt.executeUpdate(sql);

                JOptionPane.showMessageDialog(rootPane, "Successfully Added New Brand to Database:", "Successfully Added", JOptionPane.WARNING_MESSAGE);
                view();
                addbrand();
            }
        } catch (Exception e) {

            JOptionPane.showMessageDialog(rootPane, "Connection Error", "AddBrand", JOptionPane.ERROR_MESSAGE);
        ...
        try {
            ...
            if (!cnn.conn.isClosed()) {
                ...
                while (cnn.rs.next()) {
                    ...
                    Object o[] = {cnn.rs.getInt("BrandId"), cnn.rs.getString("BrandName")};
                    tm.addRow(o);
    ...
    public void delete() {
        ...
        try {
            ...
            String brandid = model.getValueAt(index, 0).toString();
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        int response = JOptionPane.showConfirmDialog(this, "Do you want to Add Brand?", "Confirm", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
    ...
    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
        int response = JOptionPane.showConfirmDialog(this, "Do you want to Update Brand?", "Confirm", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
        if (response == JOptionPane.YES_OPTION) {
            delete();
            view();
        } else if (response == JOptionPane.NO_OPTION) {
